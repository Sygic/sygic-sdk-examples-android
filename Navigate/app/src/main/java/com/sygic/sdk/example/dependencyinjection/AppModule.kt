...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideSdkNavigationManager(): SdkNavigationManager {
        return SdkNavigationManager()
    }

    @Singleton
    @Provides
    fun provideSdkReverseGeocoder(): SdkReverseGeocoder {
        return SdkReverseGeocoder()
    }
    ...
    @Singleton
    @Provides
    fun provideSdkVoiceManager(): SdkVoiceManager {
        return SdkVoiceManager()
    }
}